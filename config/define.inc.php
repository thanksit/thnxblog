<?php
if (!defined('thnxblog_dir')) {
	define('thnxblog_dir', _PS_MODULE_DIR_.'thnxblog/');
}
if (!defined('thnxblog_theme_dir')) {
	define('thnxblog_theme_dir', _PS_MODULE_DIR_.'thnxblog/views/templates/front/');
}
if (!defined('thnxblog_uri')) {
