...
$this->fields_form[]['form'] = array(
    ...
    'input' => array(
        ...
        array(
            ...
            'desc' => 'Which Column Do you want to use. displayleftcolumn,displayrightcolumn or displaythnxblogleft,displaythnxblogright column hook.',
            'options' => array(
                'query' => array(
                		array(
                			'id' => 'default_ps',
        ...
        array(
			...
			'values' => array(
				array(
					...
					'label' => $this->l('Default SEO Friendly: http://domain.com/module/thnxblog/single/?id_post=1'),
				),
				array(
					'id' => 'preid_seo_url',
					'value' => 'preid_seo_url',
