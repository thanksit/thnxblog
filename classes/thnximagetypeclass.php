...
class thnximagetypeclass extends ObjectModel
{
	public $id;
	public $id_thnx_image_type;
	public $name;
	public $width;
	public $height;
	public $id_shop;
	...
	public static $definition = array(
		'table' => 'thnx_image_type',
		'primary' => 'id_thnx_image_type',
		'multilang' => false,
		'fields' => array(
    ...
    public static function GetAllImageTypes()
    {
       ...
       $sql = 'SELECT * FROM `'._DB_PREFIX_.'thnx_image_type` ';
