...
{$tabkey = 0}
	...
	<div id="cart_rule_{$tabkey}" class="{$submit_action} panel cart_rule_tab thnxtheme_editor">
		{block name="fieldset"}
...
<div class="panel" id="fieldset_generate_img">
	<div class="panel-heading">
		<i class="icon-AdminParentPreferences"></i>  {l s='Regenerate Image Thumbnail'}
	</div>
	<div class="form-wrapper">
		<div class="form-group">
			<label class="control-label col-lg-3">
				{l s='Select Image Type'}
			</label>
			<div class="col-lg-9">
				<select name="select_image_type" class=" fixed-width-xl" id="select_image_type">
					<option value="all">{l s='ALL Blog Image'}</option>
					<option value="post">{l s='All Blog Post Image'}</option>
					<option value="gallery">{l s='All Blog Post Gallery Image'}</option>
					<option value="category">{l s='All Blog Category Image'}</option>
				</select>
				<p class="help-block">
					{l s='Please Select Which Type of Image You Want To Regenerate.'}
				</p>
			</div>
		</div>
	</div>
